	...
	return (
		<div className="jumbotron">
			...
			<div className="mb-2">
				...
				<p className="text-center pt-2">We are on a mission to make it easier for practitioners to reach women who want <br /> to take control of their pelvic health.  We are actively building our network.</p>
